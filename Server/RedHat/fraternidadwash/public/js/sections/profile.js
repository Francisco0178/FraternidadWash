            ...
            if(data.pub.type == "profileImage"){
              ...
              if(data.pub.photos.length == 1){
                ...
                for(var f = 0; f<limit;f++){
                  data.element.find(".attach").append('<img style="min-width:'+iW(100,src[0].height,src[0].width)+'" class="miniImageAdded loading btn" onload="imageReady(this)" src="'+src[f].url+'m">');
                }
                if(total > 5){
